...
public class SysDeptController extends AbstractController {
	...
	public R list(){
        ...
        return R.ok().put("data", deptList).put("count",deptList.size());
	}
	...
	public R save(@RequestBody SysDeptEntity dept){
        dept.setCreateId(getUserId().intValue());
	...
	public R update(@RequestBody SysDeptEntity dept){
        dept.setUpdateId(getUserId().intValue());
	...
	public R selectRelationship(long roleIds){
		SysUserEntity sysUserEntity = this.getUser();
		Map<Long, String> deptList = sysDeptService.encapsulationDeptTree(Integer.parseInt(sysUserEntity.getDeptId().toString()),roleIds);
		R r = R.ok().put("id",deptList);
		return r;
	}
	 ...
	 * @return
	 */
	@RequestMapping("/selectMktRelationship")
	public R selectMktRelationship(long roleIds){
		SysUserEntity sysUserEntity = this.getUser();
		Map<Long, String> deptList = sysDeptService.mktDeptTree(roleIds);
		R r = R.ok().put("id",deptList);
		return r;
	}
